...
exports.provinceAndCityAndArea = provinceAndCityAndArea;

function getCityByProvince(provinceStr) {
  if (provinceStr) {
    var province
    for ( province of provinceAndCityAndArea) {
      if (province["name"] == provinceStr) {
...
exports.getCityByProvince = getCityByProvince;

function getAreaByProvinceAndCity(provinceStr, cityStr) {
  var city = getCityByProvince(provinceStr);
  if (city) {
    for (var c of city) {
      if (c["name"] == cityStr) {
        return c.area;
...
exports.getAreaByProvinceAndCity = getAreaByProvinceAndCity


exports.checkLocation = function (provinceStr, cityStr, areaStr) {
    if (provinceStr) {
        var province, city, area
        for ( province of provinceAndCityAndArea) {
            if (province["name"] == provinceStr) {
                if (cityStr) {
                    for ( city of province['city']) {
                        if (city["name"] == cityStr) {
                            if (areaStr) {
                                for (area of city["area"]) {
                                    if (area["name"] = areaStr) {
                                        return true
                                    }
                                }
                            } else {
