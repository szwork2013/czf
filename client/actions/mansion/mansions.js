 ...
 * 门卡
 */
function houseDoorCard(formData) {
return {
    [CALL_API_V1]: {
      actions: {
        successType: HOUSE_DOORCARD_SUCCESS
      },
      url: '/mansion/house/doorCard',
      method: 'POST',
      data: formData
    }
  }
}
export function houseDoorCardClick(formData) {
  return dispatch => dispatch(houseDoorCard(formData));
}
